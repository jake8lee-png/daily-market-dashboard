...
def build():
    ...
    kr_kospi = {
        ...
        "현대자동차":"005380.KS","LG에너지솔루션":"373220.KS","삼성바이오로직스":"207940.KS",
        "한화에어로스페이스":"012450.KS","기아":"000270.KS","KB금융":"105560.KS",
        "HD현대중공업":"329180.KS",
    }
    kr_kosdaq = {
    ...
    SHARES = {
        ...
        "LG에너지솔루션":234.0,"삼성바이오로직스":71.2,"한화에어로스페이스":51.6,
        "기아":397.8,"KB금융":402.3,"HD현대중공업":88.9,
        "신한지주":474.7,"삼성SDI":68.8,"NAVER":145.9,"셀트리온":215.3,"POSCO홀딩스":79.6,
